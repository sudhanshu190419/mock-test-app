...
// ΓöÇΓöÇΓöÇ Dashboard Components ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Upcoming tests (mock ΓÇö not yet in RPC) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export default function HomeScreen(): React.JSX.Element {
  ...
  // ΓöÇΓöÇ Streams listing for interactive pill selector ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Dashboard Navigation ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Role-aware section and action selection ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Student Dashboard Summary: live RPC data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  const {
  ...
  const getSubjectIcon = useCallback((subjectName: string): string => {
    ...
    if (name.includes('physics') || name.includes('phys')) return '≡ƒö¼';
    if (name.includes('chemistry') || name.includes('chem')) return '≡ƒº¬';
    if (name.includes('biology') || name.includes('bio') || name.includes('botany') || name.includes('zoology')) return '≡ƒº¼';
    if (name.includes('mathematics') || name.includes('maths') || name.includes('math')) return '≡ƒôÉ';
    if (name.includes('english') || name.includes('eng')) return '≡ƒôû';
    if (name.includes('history') || name.includes('hist')) return '≡ƒô£';
    if (name.includes('geography') || name.includes('geo')) return '≡ƒîì';
    if (name.includes('economics') || name.includes('econ')) return '≡ƒÆ░';
    if (name.includes('computer') || name.includes('cs') || name.includes('it')) return '≡ƒÆ╗';
    if (name.includes('gk') || name.includes('general') || name.includes('current')) return '≡ƒù₧∩╕Å';
    return '≡ƒôä';
  }, []);

  // ΓöÇΓöÇ Subject Analytics: live RPC data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  const {
  ...
  // ΓöÇΓöÇ Chapter Analytics: live RPC data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  const {
  ...
  // ΓöÇΓöÇ Weak Chapters: live RPC data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  const {
    data: weakChapters,
  ...
  // ΓöÇΓöÇ DIAGNOSTIC: Weak Chapters query state ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Strong Chapters: live RPC data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  const {
    data: strongChapters,
  ...
  // ΓöÇΓöÇ DIAGNOSTIC: Strong Chapters query state ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    ({ item }: { item: Section }) => {
      switch (item.id) {
        ...
        case 'overall-performance':
          ...
          if (dashboardSummaryError) {
            return (
              <View style={styles.sectionWrapper}>
                <View style={[styles.emptyCard, shadows.small]}>
                  <Text style={styles.emptyEmoji}>ΓÜá∩╕Å</Text>
        ...
        case 'continue-practice':
          ...
          // The RPC only returns basic attempt metadata ΓÇö showing "0 / 0 Questions"
          ...
          if (!lr) {
            return (
              <View style={styles.sectionWrapper}>
                <SectionHeader title="Latest Result" />
                <View style={[styles.emptyCard, shadows.small]}>
                  <Text style={styles.emptyEmoji}>≡ƒôè</Text>
