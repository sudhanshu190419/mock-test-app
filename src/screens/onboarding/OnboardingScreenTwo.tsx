/**
 * OnboardingScreenTwo — Freebuff Onboarding Screen 2
 *
 * Second screen in the onboarding flow. Mirrors OnboardingScreenOne's
 * design language and component structure, but the step indicator,
 * title, and description are positioned at the top of the screen
 * (below the Skip button), with the illustration and CTA buttons
 * below.
 *
 * ─── Layout Structure ───────────────────────────────────────────
 ...
 *     – Step group (progress "2/3" in green, title, description)
...
export default function OnboardingScreenTwo({
  onComplete,
  onNext,
}: OnboardingScreenTwoProps): React.JSX.Element {
      ...
      <View style={styles.root}>
        ...
        <View style={styles.topSection}>
          ...
          <View style={styles.stepGroup}>
            ...
            <Text style={styles.title}>Practice Smarter</Text>
...
const styles = StyleSheet.create({
  ...
  // ── Step group (2/3, title, description) ──────────────────────
  stepGroup: {
