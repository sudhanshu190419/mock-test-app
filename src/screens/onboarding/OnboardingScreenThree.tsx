/**
 * OnboardingScreenThree — Freebuff Onboarding Screen 3
 *
 * Third and final screen in the onboarding flow. Same layout as Screen
 * Two (step group positioned at top), with progress 3/3, title "Track
 * Your Growth", and description about analytics and insights.
 *
 * ─── Layout Structure ───────────────────────────────────────────
 *  • SafeAreaView with theme background
 *  • Top section:
 *     – "Skip" text button at top-right
 *     – Step group (progress "3/3" in green, title, description)
 ...
 *
 * ─── Props ──────────────────────────────────────────────────────
 *  • `onComplete` — Callback invoked when the user completes or
 *    skips onboarding.
 *  • `onNext` — Callback invoked when user taps "Next". Falls back
 *    to `onComplete` if not provided.
 *
...
export default function OnboardingScreenThree({
  onComplete,
  onNext,
}: OnboardingScreenThreeProps): React.JSX.Element {
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.root}>
        ...
        <View style={styles.topSection}>
          ...
          {/* Step group (progress, title, description) */}
...
const styles = StyleSheet.create({
  ...
  // ── Step group (3/3, title, description) ──────────────────────
  stepGroup: {
